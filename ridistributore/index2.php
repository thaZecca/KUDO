...
<main>
  <div class="container py-4">
    ...
    <div class="p-5 mb-4 bg-light rounded-3">
      <div class="container-fluid ">
        <h1 class="display-5 fw-bold">In primo piano</h1>
        <p class="col-md-8 fs-8">Qui vedrai le non conformità da risolvere.</p>
      ...
      <div class="container-fluid py-5">
        <p class="col-md-8 fs-8">Qui vedrai le non conformità da verificare.</p>
        <table class="table table-striped table-hover">
          <tr>
            <th>ID</th>
            <th>Nome</th>
