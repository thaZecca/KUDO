...
<main>
  <div class="container py-4">
    ...
    <a href="./indirizzamento.php">
      ...
      <form method="POST" action="storico2.php">
...
if (isset($_POST['ricerca'])) {
  ...
  $ricerca = '';
  if ($_POST['attributo'] == 'Origine') $ricerca = "Nome_Reparto LIKE '%".$_POST['ricerca']." %' OR ID_Fornitore LIKE '%".$_POST['ricerca']."%'";
  else $ricerca = $_POST['attributo']." LIKE '%".$_POST['ricerca']."%";
